...
local plain_map = {
	...
	["n|^"] = map_cmd("0"):with_noremap():with_desc("Move to the beginning of line"):with_silent(),
	["n|<F5>"] = map_cmd([[
...
local plug_map = {
	...
	["n|<leader>fr"] = map_cu("Telescope frecency"):with_desc("find: File by frecency"):with_silent():with_noremap(),
	["n|<leader>fu"] = map_cu("Telescope undo"):with_noremap():with_silent():with_desc("edit: Show undo history"),
	...
	-- nvim-tree
	["n|<leader>."] = map_cu("NvimTreeToggle"):with_noremap():with_silent():with_desc("NvimTree: open"),
	-- comment.nvim
